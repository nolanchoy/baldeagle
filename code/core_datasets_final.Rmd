...
Here are the data files we've compiled so far: (Key/Final datasets are **bolded**)
...
FWS_recovery: FWS dataset with recovery plan data

**expenditures_FWS_ts:** Joined dataset of FWS, FWS_recovery, and expenditures_ts
...
expenditures_FWS_ts$Class <- gsub('amphibias', 'amphibia', expenditures_FWS_ts$Class)
```