...
LPI_data<-read.csv("~/Google Drive/Boston University/Spring 2021/MA 415/Assignments/LPR2020data_public.csv")%>%
   mutate(Subspecies=ifelse(Subspecies=="NULL"|nchar(Subspecies)==0,NA,Subspecies))
```
...
<<<<<<< HEAD
## repeat
expenditures_2001<-expen_2001 %>% rename(Species_sci="Species (50 CFR Part 17)", FWS_total="FWS\r\nTotal ($)", Other_fed="Other Fed ($)", Fed_total="Fed Total ($)", States_total="States Total ($)", Species_total="Species Total ($)")%>% #rename variables
=======
...
# 
=======
>>>>>>> 3a22c3669dc5bd92e4538cf7e3cd7cddb0ee6914
```