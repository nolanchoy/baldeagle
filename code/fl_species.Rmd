...
LPI_data<-read.csv("~/Google Drive/Boston University/Spring 2021/MA 415/Assignments/LPR2020.csv")%>%
   mutate(Subspecies=ifelse(Subspecies=="NULL"|nchar(Subspecies)==0,NA,Subspecies))
```
...
redlist_data <- read_csv("~/Google Drive/Boston University/Spring 2021/MA 415/Assignments/redlistspecies.csv")
```
...
expenditure<- read_excel("~/Google Drive/Boston University/Spring 2021/MA 415/Assignments/2017-Expenditures-Report.xlsx")
...
```{r expenditure2000}
expen_2000<-read_excel("~/Google Drive/Boston University/Spring 2021/MA 415/Assignments/expenditure_2000.xlsx", 3)
=======
#2000
>>>>>>> 2ed71247f43ec8a31d009b22a55f19f87e0a15a5
...
expen_2001<-read_excel("~/Google Drive/Boston University/Spring 2021/MA 415/Assignments/expenditure_2001.xlsx", 5)

expenditures_2001<-expen_2001 %>% rename(Species_sci="Species (50 CFR Part 17)", Class="...1", FWS_total="FWS\r\nTotal ($)", Other_fed="Other Fed ($)", Fed_total="Fed Total ($)", States_total="States Total ($)", Species_total="Species Total ($)")%>% #rename variables
...
expenditures_2001<-expen_2001%>%
   rename(Species_sci="Species (50 CFR Part 17)", Class="Class",FWS_total="FWS\r\nTotal ($)", Other_fed="Other Fed ($)",Fed_total="Fed Total ($)", States_total="States Total ($)", Species_total="Species Total ($)") %>%  
   filter(!is.na(Species_sci))%>%
   filter(!is.na(Class))%>%
   mutate(temp=cumsum(Class=='Clams'))%>%
   filter(temp==0)%>% #select rows before "Fishes subtotal"
...
expen_2002 <- read_excel("~/Google Drive/Boston University/Spring 2021/MA 415/Assignments/expenditure_2002.xlsx", 5)
...
expen_2003 <- read_excel("~/Google Drive/Boston University/Spring 2021/MA 415/Assignments/expenditure_2003.xlsx", 5)
...
expen_2004 <- read_excel("~/Google Drive/Boston University/Spring 2021/MA 415/Assignments/expenditure_2004.xlsx", 5)
...
expen_2005 <- read_excel("~/Google Drive/Boston University/Spring 2021/MA 415/Assignments/expenditure_2005_06.xlsx",1)
...
expen_2006 <- read_excel("~/Google Drive/Boston University/Spring 2021/MA 415/Assignments/expenditure_2005_06.xlsx",2)
...
expen_2007 <- read_excel("~/Google Drive/Boston University/Spring 2021/MA 415/Assignments/expenditure_2007.xlsx",1)
...
expen_2008<-read_excel('../dataset/expen/expenditure_2008.xlsx',2)%>%
   select(-starts_with("..."))
expen_2008 <- read_excel("~/Google Drive/Boston University/Spring 2021/MA 415/Assignments/expenditure_2008.xlsx",2)%>%
   select(-starts_with("..."))
...
expen_2009<-read_excel('../dataset/expen/expenditure_2009.xlsx',1)%>%
   select(-starts_with("..."))
expen_2009 <- read_excel("~/Google Drive/Boston University/Spring 2021/MA 415/Assignments/expenditure_2009.xlsx")%>%
   select(-starts_with("..."))
...
#2010
expenditures_2010<-read_excel("~/Google Drive/Boston University/Spring 2021/MA 415/Assignments/expenditure_2010.xlsx",2)%>%
...
#2011
file <- "~/Google Drive/Boston University/Spring 2021/MA 415/Assignments/expenditure_2011.xlsx"
...
#2012
expen_2012 <- read_excel("~/Google Drive/Boston University/Spring 2021/MA 415/Assignments/expenditure_2012.xlsx")%>%
...
expenditures_2013 <- read_excel("~/Google Drive/Boston University/Spring 2021/MA 415/Assignments/expenditure_2013.xlsx")%>%
   select(-starts_with("...")) %>% rename(Other_fed="Other_Fed", Fed_total="Fed_Total", States_total="States_Total", Species_total="Species_Total")%>%
   filter(!is.na(Species_sci))%>%
   mutate(temp=cumsum(Class=='Clams'))%>%
   filter(temp==0)%>% #select rows before "Clams"
...
#2014
expenditures_2014 <- read_excel("~/Google Drive/Boston University/Spring 2021/MA 415/Assignments/expenditure_2014.xlsx")%>%
   select(-starts_with("...")) %>% rename(Other_fed="Other_Fed", Fed_total="Fed_Total", States_total="States_Total", Species_total="Species_Total")%>%
   filter(!is.na(Species_sci))%>%
   mutate(temp=cumsum(Class=='Clams'))%>%
   filter(temp==0)%>% #select rows before "Clams"
...
#2015
expenditures_2015 <- read_excel("~/Google Drive/Boston University/Spring 2021/MA 415/Assignments/expenditure_2015.xlsx")%>%
   select(-starts_with("..."))%>% rename(Other_fed="Other_Fed", Fed_total="Fed_Total", States_total="States_Total", Species_total="Species_Total")%>%
   filter(!is.na(Species_sci))%>%
   mutate(temp=cumsum(Class=='Clams'))%>%
   filter(temp==0)%>% #select rows before "Clams"
...
#2016
expenditures_2016 <- read_excel("~/Google Drive/Boston University/Spring 2021/MA 415/Assignments/expenditure_2016.xlsx")%>%
   select(-starts_with("..."))%>% rename(Other_fed="Other_Fed", Fed_total="Fed_Total", States_total="States_Total", Species_total="Species_Total")%>%
   filter(!is.na(Species_sci))%>%
   mutate(temp=cumsum(Class=='Clams'))%>%
   filter(temp==0)%>% #select rows before "Clams"
...
#2017
expenditures_2017 <- read_excel("~/Google Drive/Boston University/Spring 2021/MA 415/Assignments/expenditure_2017.xlsx")%>%
...
expenditures_list<-list(
   ...
   expenditures_2015,
   expenditures_2016,
   expenditures_2017)%>%lapply(expen_selection)
...
LPI_red_expen_ts$Count <- as.numeric(LPI_red_expen_ts$Count)
...
LPI_red_expen_ts%>%filter(Common_name=="Grey wolf / Gray wolf")%>%group_by(ID,Year)%>%ggplot(aes(Year,Countz))+geom_smooth(alpha=0.3)+geom_smooth(aes(y=Species_total/100000000,col="Expenditure"),alpha=0)+scale_y_continuous(name="Count (Z score)",sec.axis = sec_axis(~.*100, name ="Expenditure ($10,000,000"))+labs(title="Grey Wolf")

LPI_red_expen_ts%>%filter(Common_name=="Mountain lion / Puma / Cougar")%>%group_by(ID,Year)%>%ggplot(aes(Year,Countz))+geom_smooth(alpha=0.3)+geom_smooth(aes(y=Species_total/100000000,col="Expenditure"),alpha=0)+scale_y_continuous(name="Count (Z score)",sec.axis = sec_axis(~.*100, name ="Expenditure ($10,000,000"))+labs(title="Mountain lion / Puma / Cougar")

LPI_red_expen_ts%>%filter(Common_name=="Pronghorn")%>%group_by(ID,Year)%>%ggplot(aes(Year,Countz))+geom_smooth(alpha=0.3)+geom_smooth(aes(y=Species_total/100000000,col="Expenditure"),alpha=0)+scale_y_continuous(name="Count (Z score)",sec.axis = sec_axis(~.*100, name ="Expenditure ($10,000,000"))+labs(title="Pronghorn")

LPI_red_expen_ts%>%filter(Common_name=="Sea otter")%>%group_by(ID,Year)%>%ggplot(aes(Year,Countz))+geom_smooth(alpha=0.3)+geom_smooth(aes(y=Species_total/100000000,col="Expenditure"),alpha=0)+scale_y_continuous(name="Count (Z score)",sec.axis = sec_axis(~.*100, name ="Expenditure ($10,000,000"))+labs(title="Sea Otter")

# We can see an upward trend in counts of Sea Otter population as along with the federal expenditure over the years. Sea Otters get the 5th most federal spending in North America among all other protected species. Sea Otters are also listed "endangered' by the IUCN Redlist.

LPI_red_expen_ts%>%filter(Common_name== "American black bear")%>%group_by(ID,Year)%>%ggplot(aes(Year,Countz))+geom_smooth(alpha=0.3)+geom_smooth(aes(y=Species_total/100000000,col="Expenditure"),alpha=0)+scale_y_continuous(name="Count (Z score)",sec.axis = sec_axis(~.*100, name ="Expenditure ($10,000,000"))+labs(title="American black bear")
...
NorthA_exp %>% 
  group_by(Class) %>% 
  arrange(desc(Fed_total), by_group = TRUE) %>% 
  transmute(Common_name, Class, redlistCategory, Fed_total,Species_total)
# The top five species by the total amount of federal spending are as follows: 1) Steller Sea Lion, 2) Grey Wolf, 3) Mountain lion / Puma / Cougar, 4) Pronghorn, 5) Sea Otter

NorthA_exp %>% 
   group_by(redlistCategory) %>% 
   arrange(desc(Fed_total), by_group = TRUE) %>% 
   transmute(Common_name, redlistCategory, Fed_total,Species_total)
